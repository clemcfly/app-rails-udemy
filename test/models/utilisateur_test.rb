...
class UtilisateurTest < ActiveSupport::TestCase
  ...
  test "email validation should accept valid addresses" do
    adresses_valides = %w[user@exemple.com user@foo.COM A_US-ER@foo.bar.org first.last@foo.jp justine+jean@baz.com]
  ...
  test "email validation should reject invalid addresses" do
    adresses_invalides = %w[user@exemple,com user_at_foo.org user.name@exemple. foo@bar_baz.com foo@bar+baz.com]
